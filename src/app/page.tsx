  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-center p-4">
      ...
      <main className="z-10 flex flex-col items-center justify-center text-center text-white animate-fade-in">
        <div className="bg-black/20 backdrop-blur-md rounded-2xl p-8 sm:p-12 border border-white/10 shadow-2xl shadow-primary/40 transition-all duration-300 hover:shadow-primary/50 hover:scale-[1.02] hover:shadow-[0_0_40px_0px_hsl(var(--primary))]">
