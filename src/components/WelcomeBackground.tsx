...
const studyElements = [
  ...
  },
  {
    ...
    className: 'absolute top-[55%] right-[15%] w-40 h-auto rotate-12 animate-[pulse_12s_ease-in-out_infinite]',
    width: 400,
    height: 267,
  },
  {
  ...
  {
    id: 'book-stack',
    src: 'https://images.unsplash.com/photo-1524995767968-3da7d7805152?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
    alt: 'A stack of colorful books',
    className: 'absolute bottom-[15%] right-[10%] w-40 h-auto rotate-3 animate-[pulse_13s_ease-in-out_infinite]',
    width: 400,
    height: 267,
  },
];
